...
namespace constants
{
    ...
    inline constexpr const char* ConfigKeyOvernightSleepStart = "n";
    inline constexpr const char* ConfigKeyOvernightSleepLength = "l";
    inline constexpr const char* ConfigKeyDisplaySimpleBattery = "b";
