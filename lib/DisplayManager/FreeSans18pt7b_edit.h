...
// this file is an edited version of the Adafruit <Fonts/FreeSans18pt7b.h> that alters
...
const uint8_t FreeSans18pt7bBitmaps[] PROGMEM = {
  ...
  , 
...
const GFXglyph FreeSans18pt7bGlyphs[] PROGMEM = {
  ...
  {    20,   9,   9,  12,    1,  -24 },   // 0x22 '"'
  {    31,  16,  25,  19,    2,  -24 },   // 0x23 '#'
  {    81,  16,  30,  19,    2,  -26 },   // 0x24 '$'
  {   141,  29,  25,  31,    1,  -24 },   // 0x25 '%'
  {   232,  21,  27,  23,    1,  -26 },   // 0x26 '&'
  {   304,   3,   9,   7,    2,  -24 },   // 0x27 '''
  {   308,   8,  33,  12,    3,  -25 },   // 0x28 '('
  {   341,   8,  33,  12,    1,  -25 },   // 0x29 ')'
  {   374,  10,  10,  14,    2,  -25 },   // 0x2A '*'
  {   387,  16,  16,  20,    2,  -15 },   // 0x2B '+'
  {   419,   3,   9,  10,    3,   -3 },   // 0x2C ','
  {   423,   8,   3,  12,    2,  -10 },   // 0x2D '-'
  {   426,   3,   4,   9,    3,   -3 },   // 0x2E '.'
  {   428,  10,  26,  10,    0,  -25 },   // 0x2F '/'
  {   461,  16,  25,  19,    2,  -24 },   // 0x30 '0'
  {   511,   8,  25,  19,    4,  -24 },   // 0x31 '1'
  {   536,  16,  25,  19,    2,  -24 },   // 0x32 '2'
  {   586,  17,  25,  19,    1,  -24 },   // 0x33 '3'
  {   640,  16,  25,  19,    1,  -24 },   // 0x34 '4'
  {   690,  17,  25,  19,    1,  -24 },   // 0x35 '5'
  {   744,  16,  25,  19,    2,  -24 },   // 0x36 '6'
  {   794,  16,  25,  19,    2,  -24 },   // 0x37 '7'
  {   844,  17,  25,  19,    1,  -24 },   // 0x38 '8'
  {   898,  16,  25,  19,    1,  -24 },   // 0x39 '9'
  {   948,   3,  19,   9,    3,  -18 },   // 0x3A ':'
  {   956,   3,  24,   9,    3,  -18 },   // 0x3B ';'
  {   965,  17,  17,  20,    2,  -16 },   // 0x3C '<'
  {  1002,  17,   9,  20,    2,  -12 },   // 0x3D '='
  {  1022,  17,  17,  20,    2,  -16 },   // 0x3E '>'
  {  1059,  15,  26,  19,    3,  -25 },   // 0x3F '?'
  {  1108,  32,  31,  36,    1,  -25 },   // 0x40 '@'
  {  1232,  22,  26,  23,    1,  -25 },   // 0x41 'A'
  {  1304,  19,  26,  23,    3,  -25 },   // 0x42 'B'
  {  1366,  22,  26,  25,    1,  -25 },   // 0x43 'C'
  {  1438,  20,  26,  24,    3,  -25 },   // 0x44 'D'
  {  1503,  18,  26,  22,    3,  -25 },   // 0x45 'E'
  {  1562,  17,  26,  21,    3,  -25 },   // 0x46 'F'
  {  1618,  24,  26,  27,    1,  -25 },   // 0x47 'G'
  {  1696,  19,  26,  25,    3,  -25 },   // 0x48 'H'
  {  1758,   3,  26,  10,    4,  -25 },   // 0x49 'I'
  {  1768,  14,  26,  18,    1,  -25 },   // 0x4A 'J'
  {  1814,  20,  26,  24,    3,  -25 },   // 0x4B 'K'
  {  1879,  15,  26,  20,    3,  -25 },   // 0x4C 'L'
  {  1928,  24,  26,  30,    3,  -25 },   // 0x4D 'M'
  {  2006,  20,  26,  26,    3,  -25 },   // 0x4E 'N'
  {  2071,  25,  26,  27,    1,  -25 },   // 0x4F 'O'
  {  2153,  18,  26,  23,    3,  -25 },   // 0x50 'P'
  {  2212,  25,  28,  27,    1,  -25 },   // 0x51 'Q'
  {  2300,  20,  26,  25,    3,  -25 },   // 0x52 'R'
  {  2365,  20,  26,  23,    1,  -25 },   // 0x53 'S'
  {  2430,  19,  26,  22,    1,  -25 },   // 0x54 'T'
  {  2492,  19,  26,  25,    3,  -25 },   // 0x55 'U'
  {  2554,  21,  26,  23,    1,  -25 },   // 0x56 'V'
  {  2623,  32,  26,  33,    0,  -25 },   // 0x57 'W'
  {  2727,  21,  26,  23,    1,  -25 },   // 0x58 'X'
  {  2796,  23,  26,  24,    0,  -25 },   // 0x59 'Y'
  {  2871,  19,  26,  22,    1,  -25 },   // 0x5A 'Z'
  {  2933,   6,  33,  10,    2,  -25 },   // 0x5B '['
  {  2958,  10,  26,  10,    0,  -25 },   // 0x5C '\'
  {  2991,   6,  33,  10,    1,  -25 },   // 0x5D ']'
  {  3016,  13,  13,  16,    2,  -24 },   // 0x5E '^'
  {  3038,  21,   2,  19,   -1,    5 },   // 0x5F '_'
  {  3044,   7,   5,   9,    1,  -25 },   // 0x60 '`'
  {  3049,  17,  19,  19,    1,  -18 },   // 0x61 'a'
  {  3090,  16,  26,  20,    2,  -25 },   // 0x62 'b'
  {  3142,  16,  19,  18,    1,  -18 },   // 0x63 'c'
  {  3180,  17,  26,  20,    1,  -25 },   // 0x64 'd'
  {  3236,  16,  19,  19,    1,  -18 },   // 0x65 'e'
  {  3274,   7,  26,  10,    1,  -25 },   // 0x66 'f'
  {  3297,  16,  27,  19,    1,  -18 },   // 0x67 'g'
  {  3351,  15,  26,  19,    2,  -25 },   // 0x68 'h'
  {  3400,   3,  26,   8,    2,  -25 },   // 0x69 'i'
  {  3410,   6,  34,   9,    0,  -25 },   // 0x6A 'j'
  {  3436,  16,  26,  18,    2,  -25 },   // 0x6B 'k'
  {  3488,   3,  26,   7,    2,  -25 },   // 0x6C 'l'
  {  3498,  24,  19,  28,    2,  -18 },   // 0x6D 'm'
  {  3555,  15,  19,  19,    2,  -18 },   // 0x6E 'n'
  {  3591,  17,  19,  19,    1,  -18 },   // 0x6F 'o'
  {  3632,  16,  25,  20,    2,  -18 },   // 0x70 'p'
  {  3682,  17,  25,  20,    1,  -18 },   // 0x71 'q'
  {  3736,   9,  19,  12,    2,  -18 },   // 0x72 'r'
  {  3758,  14,  19,  17,    2,  -18 },   // 0x73 's'
  {  3792,   7,  23,  10,    1,  -22 },   // 0x74 't'
  {  3813,  15,  19,  19,    2,  -18 },   // 0x75 'u'
  {  3849,  17,  19,  17,    0,  -18 },   // 0x76 'v'
  {  3890,  25,  19,  25,    0,  -18 },   // 0x77 'w'
  {  3950,  16,  19,  17,    0,  -18 },   // 0x78 'x'
  {  3988,  17,  27,  17,    0,  -18 },   // 0x79 'y'
  {  4046,  15,  19,  17,    1,  -18 },   // 0x7A 'z'
  {  4082,   8,  33,  12,    1,  -25 },   // 0x7B '{'
  {  4115,   2,  33,   9,    3,  -25 },   // 0x7C '|'
  {  4124,   8,  33,  12,    3,  -25 },   // 0x7D '}'
  {  4157,  15,   7,  18,    1,  -15 }    // 0x7E '~'
};
