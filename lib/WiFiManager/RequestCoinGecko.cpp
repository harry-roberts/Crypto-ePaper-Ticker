...
namespace
{
    ...
    // the coingecko api cannot be called with symbol, they annoyingly have their own ids
    std::map<String, String> coinGeckoSymbolToId = {{"BTC", "bitcoin"},
                                                    {"ETH", "ethereum"},
                                                    {"BNB", "binancecoin"},
                                                    {"SOL", "solana"},
                                                    {"XRP", "ripple"},
